...
- **지식 컴파일** — `llm-wiki`가 Karpathy LLM Wiki 패턴으로 프로젝트 문서를 `wiki/`에 교차참조 마크다운으로 컴파일합니다. RAG 재검색이 아닌 복리 축적 모델. qmd 하이브리드 검색 자동 활성, LanceDB + Embedding Atlas 선택적.
